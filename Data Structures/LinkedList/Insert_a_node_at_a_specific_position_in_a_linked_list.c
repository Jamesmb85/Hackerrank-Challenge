...
SinglyLinkedListNode *insertNodeAtPosition(SinglyLinkedListNode *llist, int data, int position)
{
    ...
    {
        // create a new node
        struct SinglyLinkedListNode *positionNode = create_singly_linked_list_node(data);
        positionNode->next = llist;
        return positionNode;
    }

    // temp node used to iterate through the list
    struct SinglyLinkedListNode *curr = llist;

    // traverse the node to positon - 1
