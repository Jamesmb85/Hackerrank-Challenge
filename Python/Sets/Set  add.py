...
number_of_stamps = int(input("How many stamps do you have? \n"))
unique_stamps = set()
for name in range(number_of_stamps):
    nameOfStamp = input("What is the county's stamp name: ")
    unique_stamps.add(nameOfStamp)
